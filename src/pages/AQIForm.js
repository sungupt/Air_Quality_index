...
const AQIForm = () => {
  ...
  useEffect(() => {
    const fetchCountries = async (inputText, callback) => {
      const responseData = await fetch(
        `https://api.airvisual.com/v2/countries?key=6fd4dde7-9338-4c95-b522-f59718eef025`
      );
  ...
  const fetchStates = async () => {
    const responseData = await fetch(
      `https://api.airvisual.com/v2/states?country=${country}&key=6fd4dde7-9338-4c95-b522-f59718eef025`
    );
  ...
  const fetchCities = async () => {
    const responseData = await fetch(
      `https://api.airvisual.com/v2/cities?state=${state}&country=${country}&key=6fd4dde7-9338-4c95-b522-f59718eef025`
    );
  ...
  const CityDataProvider = async () => {
    const responseData = await fetch(
      `https://api.airvisual.com/v2/city?city=${city}&state=${state}&country=${country}&key=6fd4dde7-9338-4c95-b522-f59718eef025`
    );
